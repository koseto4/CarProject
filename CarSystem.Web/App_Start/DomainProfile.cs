    ...
    public class DomainProfile:Profile
    {
        ...
        public DomainProfile()
        {
            CreateMap<Car, CarViewModel>()
                ...
                .ForMember(dest => dest.PhoneNumber, opt => opt.MapFrom(t => t.User.PhoneNumber))
                .ForMember(dest => dest.FirstName, opt => opt.MapFrom(t => t.User.FirstName))
                .ForMember(dest => dest.LastName, opt => opt.MapFrom(t => t.User.LastName))
                ;
